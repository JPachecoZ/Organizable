...
function renderStarredButtons(){
  return `
    ...
    <div class="board-card__button active starred-button">
      <svg
        width="18"
        height="17"
        viewBox="0 0 18 17"
...
function renderBoardsButtons(){
  return `
    ...
    <div class="board-card__button starred-button">
      <svg
        width="18"
        height="17"
        viewBox="0 0 18 17"
...
function renderBoard(board) {
  return `
  <div class="board-card bg-${board.color}" data-id="${board.id}" data-starred="${board.starred}" data-closed="${board.closed}">
...
function render() {
  const boardList = STORE.unStarredBoards;
  ...
  return `
      ...
      <div class="board-cards">
        ...
        <div class="board-card board-create">
...
function listenToAddBoard() {
  try {
    const toAddBoardButton = document.querySelector(".board-create")

    toAddBoardButton.addEventListener("click", () => {
